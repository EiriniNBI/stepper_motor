...
class LinearStage():
    """
    In [57]: a.sequence([1, 2, 3],[1, 2, 3])
--------------------------------------------------------------------------
TypeError                                Traceback (most recent call last)
<ipython-input-57-056508262010> in <module>
----> 1 a.sequence([1, 2, 3],[1, 2, 3])

TypeError: sequence() takes 2 positional arguments but 3 were given
